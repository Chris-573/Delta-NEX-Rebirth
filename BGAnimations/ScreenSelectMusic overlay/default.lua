...
t[#t+1] = Def.ActorFrame{
	LoadActor(THEME:GetPathG("","JoinOverlay"))..{
		InitCommand=cmd(xy,SCREEN_WIDTH*.15,SCREEN_CENTER_Y+60;zoom,.9;visible,THEME:GetMetric("GameState", "AllowLateJoin");playcommand,"RefreshPlayer");
	...
	LoadActor(THEME:GetPathG("","JoinOverlay"))..{
		InitCommand=cmd(xy,SCREEN_WIDTH*.85,SCREEN_CENTER_Y+60;zoom,.9;visible,THEME:GetMetric("GameState", "AllowLateJoin");playcommand,"RefreshPlayer");
		PlayerJoinedMessageCommand=cmd(playcommand,"RefreshPlayer");
		CoinModeChangedMessageCommand=cmd(playcommand,"RefreshPlayer");
		CoinInsertedMessageCommand=cmd(playcommand,"RefreshPlayer");
		RefreshPlayerCommand=function(self)
