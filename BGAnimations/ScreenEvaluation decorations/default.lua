...
t[#t+1] = Def.ActorFrame{
	...
	LoadActor(THEME:GetPathG("","PlayerSteps"), PLAYER_1)..{
		InitCommand=cmd(draworder,100;zoom,0.925;x,-160;y,-10;visible,GAMESTATE:IsSideJoined(PLAYER_1));
	};
	LoadActor(THEME:GetPathG("","PlayerSteps"), PLAYER_2)..{
		InitCommand=cmd(draworder,100;zoom,0.925;x,160;y,-10;visible,GAMESTATE:IsSideJoined(PLAYER_2));
	};
